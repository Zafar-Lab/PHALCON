...
loomFilename = './sample_data/sample_loom.loom'
mpileupFileName = "./sample_data/sample_loom.mpileup"
rcFileName = "./sample_data/sample_rc.tsv"
quality_file = "./sample_data/sample_gq.tsv"
